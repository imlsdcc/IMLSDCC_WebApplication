...
var dcc = function () {
    //Private Vars
    var serviceUrl = "http://imlsdccweb.grainger.illinois.edu/Service/";
    var data = {
        /*
...
//                        } else {
//                            $('#' + appendDiv + '-matches ol:not(' + pageNumberDiv + ')').hide();
//                            $('#' + appendDiv + '-matches').append('<ol id="' + appendDiv + '-page-' + currentPageNum + '"></ol>').hide();
//                            $(pageNumberDiv).hide();
...
//                            for (i in json.itemList) {
//                                var result = json.itemList[i];
//                                var rurl = "/Service" + result.briefuri;
//                                var did = appendDiv + '_' + currentPageNum + "_result_" + i;
//                                createResultStrip(result, appendDiv + '_' + currentPageNum + "_result_" + i).appendTo(pageNumberDiv);
//                                //                                addOrCallBrief(rurl, function (jsonB) {
//                                //                                    if (jsonB.errors.length < 1) {
//                                //                                        //console.log(div_id);
//                                //                                        drawBrief(jsonB, "#" + appendDiv + '_' + currentPageNum + "_result_" + i);
//                                //                                        console.log(rurl, did, "#" + appendDiv + '_' + currentPageNum + "_result_" + i);
//                                //                                    } else {
...
//                    }
        ...
        drawPreLoad: function (json, pageNumberDiv, appendDiv, currentPageNum) {
        ...
        secondarySources: function () {
            ...
            jQuery.each(secTargets, function (n, target) { // for each Secondary Source, call searchaid w/the user's search phrase
                $('#meta_search_' + target).load("http://imlsdccweb.grainger.illinois.edu/Service/Browse/secondarySources", { q: phrase, db: target });
            });
        }
