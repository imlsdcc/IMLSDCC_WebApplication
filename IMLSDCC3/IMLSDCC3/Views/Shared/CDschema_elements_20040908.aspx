...
<div class="panel">
    <td colspan="2" valign="top">
      ...
      Collection Description Metadata Schema 2004-09-08 </td>
            </tr>
            <tr>
            ...
            <tr>
              ...
              <td width="75%" class="sidebar"><a href="CDschema_elements_20040908">http://imlsdcc.grainger.uiuc.edu/CDschema_elements_20040908</a></td>
            </tr>
            <tr>
            ...
            <tr>
              ...
              <td width="75%" class="sidebar">This document describes the IMLS DCC Collection Description Metadata Schema version 2004-09-08.</td>
            </tr>
          </table>          <p >&nbsp;</p>
          ...
          <p class="BodyText" >The following is a <strong>detailed</strong> look
            ...
            see the <a href="CDschema_overview">General Overview</a> page.</p>
          ...
          <blockquote>
            ...
            <ul>
              ...
              <li><a href="#collection_URL">imls:URL</a></li>
              ...
              <li><a href="#collection_accrualPeriodicity">imls:accrualPeriodicity</a></li>
              ...
              <li><a href="#collection_collectionPolicy">imls:collectionPolicy</a></li>
              <li><a href="#collection_isAvailableAt">cld_gen:isAvailableAt</a></li>
            ...
            <ul>
              ...
              <li><a href="#collection_description">dc:description</a></li>
          ...
          <ul>
            ...
            <li class="BodyText"><a href="#project_URL">imls:URL</a></li>
          ...
          <ul>
            <li class="BodyText"><a href="#institution_title">dc:title</a></li>
            <li class="BodyText"><a href="#institution_identifier">dc:identifier</a></li>
            <li class="BodyText"><a href="#institution_type">dc:type</a></li>
            <li class="BodyText"><a href="#institution_state">imls:state</a></li>
            <li class="BodyText"><a href="#institution_zipCode">imls:zipCode</a></li>
            </ul>          
          <p class="pagesubheading"><a name="administrator"></a>Administrator Entity</p>
          <ul>
            <li><a href="#administrator_name">vcard:fn</a></li>
            <li><a href="#administrator_identifier">dc:identifier</a></li>
            <li><a href="#administrator_email">vcard:email</a></li>
            <li><a href="#administrator_affiliation">vcard:org</a></li>
          </ul>          <p><span class="Heading3">Collection Entity</span> <span class="back">(back to <a href="#top">top</a>)</span></p>
	...
	<blockquote>
	  ...
	  <p class="tableBlockquote">The Louisiana Purchase: A Heritage Explored</p>
              ...
              <table width="85%" border="1" align="center" cellpadding="4" cellspacing="1" id="collection_URL">
                <tr>
                  <td class="tableLabel" width="15%" valign="top" align="left"> Name </td>
                  <td class="table" width="85%" valign="top" align="left"> <a name="collection_URL"></a>imls:URL</td>
                </tr>
                <tr>
                  <td class="tableLabel" width="20%" valign="top" align="left"> Label </td>
              ...
              <table width="85%" border="1" align="center" cellpadding="4" cellspacing="1" id="collection_accrualPeriodicity">
                <tr>
                  <td class="tableLabel" width="15%" valign="top" align="left"> Name </td>
                  <td class="table" width="85%" valign="top" align="left"> <a name="collection_accrualPeriodicity" id="collection_accrualPeriodicity"></a>imls:accrualPeriodicity</td>
                </tr>
                <tr>
                  <td class="tableLabel" width="20%" valign="top" align="left"> Label </td>
                ...
                <tr class="local" bgcolor="#FFFFFF">
                  <td align="left" valign="top" class="tableLabel">Refines</td>
                  <td align="left" valign="top" class="table">cld:accrualStatus</td>
                </tr>
                <tr class="local" bgcolor="#FFFFFF">
                  <td width="20%" align="left" valign="top" class="tableLabel"> Comments </td>
            ...
            <table width="85%" border="1" align="center" cellpadding="4" cellspacing="1" id="collection_audience">
              ...
              <table width="85%" border="1" align="center" cellpadding="4" cellspacing="1" id="collection_collectionPolicy">
                <tr>
                  <td class="tableLabel" width="15%" valign="top" align="left"> Name </td>
                  <td class="table" width="85%" valign="top" align="left"> <a name="collection_collectionPolicy"></a>imls:collectionPolicy</td>
                </tr>
                <tr>
                  <td class="tableLabel" width="20%" valign="top" align="left"> Label </td>
                ...
                <tr class="local" bgcolor="#FFFFFF">
                  <td align="left" valign="top" class="tableLabel">Refines</td>
                  <td align="left" valign="top" class="table"><p>dc:description</p>
                  </td>
                </tr>
                <tr class="local" bgcolor="#FFFFFF">
                  <td width="20%" align="left" valign="top" class="tableLabel"> Comments </td>
              ...
              <table width="85%" border="1" align="center" cellpadding="4" cellspacing="1" id="collection_isAvailableAt">
                <tr>
                  <td class="tableLabel" width="15%" valign="top" align="left"> Name </td>
                  <td class="table" width="85%" valign="top" align="left"> <a name="collection_isAvailableAt"></a>cld_gen:isAvailableAt</td>
                </tr>
                <tr>
                  <td class="tableLabel" width="20%" valign="top" align="left"> Label </td>
              ...
              <table width="85%" border="1" align="center" cellpadding="4" cellspacing="1" id="collection_notes">
                ...
                <tr class="local" bgcolor="#FFFFFF">
                  ...
                  <td width="80%" align="left" valign="top" bgcolor="#FFFFFF" class="table"><p>This
                    ...
                    <blockquote>
                      <p>Example:</p>
                      <p><em>This digital collection and web site will be completed
              ...
              to <a href="#top">top</a>)</span></strong></p>              <table width="85%" border="1" align="center" cellpadding="4" cellspacing="1" id="collection_subject">
                ...
                <tr class="local" bgcolor="#FFFFFF">
                  ...
                  <td width="80%" align="left" valign="top" bgcolor="#FFFFFF" class="table"><p>The
                    ...
                    <blockquote>
                      <p>Examples:</p>
                      <p><em>Social Studies (GEM)</em></p>
                      <p><em>Current events/issues (GEM)</em></p>
                      <p><em>Work Projects Administration. Museum Extension Project</em></p>
                      <p>&nbsp;</p>
                    </blockquote></td>
                </tr>
              </table>              
              ...
              <table width="85%" border="1" align="center" cellpadding="4" cellspacing="1" id="collection_description">
                <tr>
                  <td class="tableLabel" width="15%" valign="top" align="left"> Name </td>
                  <td class="table" width="85%" valign="top" align="left"> <a name="collection_description"></a>dc:description</td>
                </tr>
                <tr>
                  <td class="tableLabel" width="20%" valign="top" align="left"> Label </td>
                ...
                <tr class="local" bgcolor="#FFFFFF">
                  ...
                  <td width="80%" align="left" valign="top" bgcolor="#FFFFFF" class="table"><p>The
                    ...
                    <blockquote>
                        ...
                        <p><em>Mountain States.</em></p>
                        <p><em>Colorado (state)</em></p>
                    </blockquote>
                  </td>
                </tr>
              </table>              
              ...
              <p align="left"><strong><a name="collection_relcoll"></a>Attributes describing relationships with
                ...
                <tr class="local" bgcolor="#FFFFFF">
                  ...
                  <td width="80%" align="left" valign="top" bgcolor="#FFFFFF" class="table"><p>The
                    ...
                    <blockquote>
                        <p>Examples:</p>
                        <p><em>Springfield College YMCA Historical Image Collection</em></p>
                    </blockquote>
                  </td>
                </tr>
              </table>              
              ...
              <table width="85%" border="1" align="center" cellpadding="4" cellspacing="1" id="collection_hasPart">
                ...
                <tr class="local" bgcolor="#FFFFFF">
                  ...
                  <td width="80%" align="left" valign="top" bgcolor="#FFFFFF" class="table"><p>The
                    ...
                    <blockquote>
                      <p>Examples:</p>
                      <p><em>YMCA Training School Image Collection </em></p>
                      <p><em>YMCA Portrait
                      Collection </em></p>
                      <p><em>YMCA World War I Image Collection </em></p>
                    </blockquote></td>
                </tr>
              </table>              
              <p align="center"><strong><span class="back">(back to <a href="#top">top</a>)</span></strong></p>
              <table width="85%" border="1" align="center" cellpadding="4" cellspacing="1" id="collection_source">
                ...
                <tr class="local" bgcolor="#FFFFFF">
                  ...
                  <td width="80%" align="left" valign="top" bgcolor="#FFFFFF" class="table"><p>A
                      ...
                      <blockquote>
                        <p>Examples:</p>
                        <p><em>Detroit News Photo Archive</em></p>
                    </blockquote>
                  </td>
                </tr>
              </table>
              ...
              <table width="85%" border="1" align="center" cellpadding="4" cellspacing="1" id="collection_relation">
                ...
                <tr class="local" bgcolor="#FFFFFF">
                  ...
                  <td width="80%" align="left" valign="top" bgcolor="#FFFFFF" class="table"><p>A
                      ...
                      <blockquote>
                        <p>Examples:</p>
                        <p><em>American Memory Project (Library of Congress)</em></p>
                      </blockquote>
                  </td>
                </tr>
              </table>              
              ...
              <table width="85%" border="1" align="center" cellpadding="4" cellspacing="1" id="collection_creator">
                ...
                <tr class="local" bgcolor="#FFFFFF">
                  <td width="20%" height="128" align="left" valign="top" class="tableLabel"> Comments </td>
                  <td width="80%" align="left" valign="top" bgcolor="#FFFFFF" class="table"><p>This
              ...
              <p><span class="Heading3">Project Entity</span> <span class="back">(back
                ...
                <tr class="local" bgcolor="#FFFFFF">
                  ...
                  <td width="85%" align="left" valign="top" bgcolor="#FFFFFF" class="table"><p>A
                    ...
                    <blockquote>
                      <p>Example:</p>
                      <p><em>The Urban Beat: The Detroit News Collection 1900-1980</em></p>
                    </blockquote>
                  </td>
                </tr>
              </table>
              ...
              <table width="85%" border="1" align="center" cellpadding="4" cellspacing="1" id="project_URL">
                <tr>
                  <td class="tableLabel" width="15%" valign="top" align="left"> Name </td>
                  <td class="table" width="85%" valign="top" align="left"><a name="project_URL"></a>imls:URL</td>
                </tr>
                <tr>
                  <td width="20%" height="27" align="left" valign="top" class="tableLabel"> Label </td>
                ...
                <tr class="local" bgcolor="#FFFFFF">
                  ...
                  <td width="80%" align="left" valign="top" bgcolor="#FFFFFF" class="table"><p>The
                      ...
                      <blockquote>
                        <p>Examples:</p>
                        <p><em>http://africafocus.library.wisc.edu/project.htm</em> </p>
                    </blockquote>
                  </td>
                </tr>
              </table>              
              ...
              <table width="85%" border="1" align="center" cellpadding="4" cellspacing="1" id="institution_title">
                <tr>
                  <td class="tableLabel" width="15%" valign="top" align="left"> Name </td>
                  <td class="table" width="85%" valign="top" align="left"><a name="institution_title"></a>dc:title</td>
                </tr>
                <tr>
                  <td width="20%" height="27" align="left" valign="top" class="tableLabel"> Label </td>
              ...
              <table width="85%" border="1" align="center" cellpadding="4" cellspacing="1" id="institution_identifier">
                <tr>
                  <td class="tableLabel" width="15%" valign="top" align="left"> Name </td>
                  <td class="table" width="85%" valign="top" align="left"><a name="institution_identifier"></a>dc:identifier</td>
                </tr>
                <tr>
                  <td width="20%" height="27" align="left" valign="top" class="tableLabel"> Label </td>
                  <td class="table" width="80%" valign="top" align="left"> Identifier
              ...
              <table width="85%" border="1" align="center" cellpadding="4" cellspacing="1" id="institution_type">
                <tr>
                  <td class="tableLabel" width="15%" valign="top" align="left"> Name </td>
                  <td class="table" width="85%" valign="top" align="left"><a name="institution_type"></a>dc:type</td>
                </tr>
                <tr>
                  <td width="20%" height="27" align="left" valign="top" class="tableLabel"> Label </td>
                  <td class="table" width="80%" valign="top" align="left"> Institution
...
categorization is based on the institution types in the grant proposal guidelines
              ...
              <table width="85%" border="1" align="center" cellpadding="4" cellspacing="1" id="institution_state">
                <tr>
                  <td class="tableLabel" width="15%" valign="top" align="left"> Name </td>
                  <td class="table" width="85%" valign="top" align="left"><a name="institution_state"></a>imls:state</td>
                </tr>
                <tr>
                  <td width="20%" height="27" align="left" valign="top" class="tableLabel"> Label </td>
              ...
              <table width="85%" border="1" align="center" cellpadding="4" cellspacing="1" id="institution_zipCode">
                <tr>
                  <td class="tableLabel" width="15%" valign="top" align="left"> Name </td>
                  <td class="table" width="85%" valign="top" align="left"><a name="institution_zipCode"></a>imls:zipCode</td>
                </tr>
                <tr>
                  <td width="20%" height="27" align="left" valign="top" class="tableLabel"> Label </td>
              ...
              <p align="left"><span class="Heading3">Administrator Entity</span> <span class="back">(back
                ...
                <tr>
                  <td class="tableLabel" width="20%" valign="top" align="left"> Name </td>
                  <td class="table" width="85%" valign="top" align="left"><a name="administrator_name"></a>vcard:fn</td>
                </tr>
                <tr>
                  <td width="20%" height="27" align="left" valign="top" class="tableLabel"> Label </td>
                ...
                <tr class="local" bgcolor="#FFFFFF">
                  ...
                  <td width="85%" align="left" valign="top" bgcolor="#FFFFFF" class="table"><p>The
                    ...
                    for the benefit of IMLS.</p>
			         ...
			         <table width="85%" border="1" align="center" cellpadding="4" cellspacing="1" id="administrator_identifier">
                <tr>
                  <td class="tableLabel" width="20%" valign="top" align="left"> Name </td>
                  <td class="table" width="85%" valign="top" align="left"><a name="administrator_identifier"></a>dc:identifier</td>
                </tr>
                <tr>
                  <td width="20%" height="27" align="left" valign="top" class="tableLabel"> Label </td>
                ...
                <tr>
                  <td class="tableLabel" width="20%" valign="top" align="left"> Name </td>
                  <td class="table" width="85%" valign="top" align="left"><a name="administrator_affiliation"></a>vcard:org</td>
                </tr>
                <tr>
                  <td width="20%" height="27" align="left" valign="top" class="tableLabel"> Label </td>
                ...
                <tr class="local" bgcolor="#FFFFFF">
                  ...
                  <td width="85%" align="left" valign="top" bgcolor="#FFFFFF" class="table">The
                    ...
                    for the benefit of IMLS.</td>
                     ...
                     <p>&nbsp;</p>              <p ><span class="Heading3"><a name="namespaces"></a>Schemas
            ...
            to <a href="#top">top</a>)</span></p>
              <table width="77%" border="1" cellpadding="3" cellspacing="0" id="schemas_vocabularies">
                ...
                <tr class="table">
                  ...
                  <td><p>reference:</p>
                      <p><a href="CDschema_elements.htm">http://imlsdcc.grainger.uiuc.edu/CDschema_elements.htm</a></p>
                  </td>
                </tr>
                <tr class="table">
                  <td>vcard:</td>
